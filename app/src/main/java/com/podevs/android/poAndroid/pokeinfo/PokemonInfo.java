...
public class PokemonInfo {
	...
	public static int type1(UniqueID uID, int gen) {
		...
		try {
			...
			//e.printStackTrace();
			Log.e("PokemonInfo1", "NULL original uID:" + uID);
		}
		return type;
	}
	...
	public static int type2(UniqueID uID, int gen) {
		...
		try {
			...
			Log.e("PokemonInfo2", "NULL original uID:" + uID);
		}
		return type;
	}
	...
	public static Drawable iconDrawablePokeballStatus() {
		...
		return Objects.requireNonNull(drawable.mutate().getConstantState()).newDrawable();
	}
